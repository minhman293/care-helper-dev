import 'package:chelper_man/presentation/views/signup/new_password/new_password_screen.dart';
...
class PinAuthenScreen extends StatefulWidget {
  const PinAuthenScreen({Key? key, required this.phoneNumber})
      : super(key: key);
  final String phoneNumber;

  @override
  State<PinAuthenScreen> createState() => _PinAuthenScreenState();
}

class _PinAuthenScreenState extends State<PinAuthenScreen> {
